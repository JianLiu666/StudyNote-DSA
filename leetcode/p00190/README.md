[![image](https://img.shields.io/badge/Leetcode-Link-blue?logo=leetcode)](https://leetcode.com/problems/reverse-bits/)
...
`Bit Manipulation` 暖身題，遍歷一次 `num` 在對應位置將數字填上答案即可，直接看程式碼吧